...
SIZE = 96           # menus, kodex, title: 2x grid detail, 1px cells
DETAIL = 2
BATTLE_SIZE = 132   # battle: same creatures at 3x grid detail, 1px cells
BATTLE_DETAIL = 3
FRAMES = 4
...
ZNOMES = [
    (name, lambda s=seed, d=dark, k=knobs: _frames(s, d, k, SIZE, 1, DETAIL))
