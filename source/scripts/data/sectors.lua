...
--- sector is generated from these parameters by world/mapgen.lua.
...
Sectors.list = {
	...
	{
		id = "flats", name = "DUST FLATS", generated = true,
	...
	{
		id = "canyon", name = "RUST CANYON", generated = true,
	...
	{
		id = "tubes", name = "LAVA TUBES", generated = true,
	...
	{
		id = "relay", name = "RELAY STATION", generated = true,
	...
	{
		id = "anomaly", name = "ANOMALY FIELD", generated = true,
